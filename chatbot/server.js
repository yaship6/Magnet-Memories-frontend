...
const answers = [
  {
    ...
    reply:
      "Square Photo Magnets are Rs. 99, Big Acrylic Magnet Frames are Rs. 199, and Strip Acrylic Magnet Frames are Rs. 249. Custom designs may vary depending on quantity and style.",
  },
  {
    keywords: ["custom", "customize", "photo", "upload", "picture"],
    reply:
      "You can customize products from the Customize page. Square Photo Magnets and Big Acrylic Magnet Frames need 1 picture, while Strip Acrylic Magnet Frames need 3 pictures.",
  },
  {
    keywords: ["strip"],
    reply:
      "Strip Acrylic Magnet Frames are rectangle-shaped and made for 3 pictures in one frame. They are perfect for mini story-style memories.",
  },
  {
    keywords: ["square"],
    reply:
  ...
  },
  {
    ...
    reply:
      "Big Acrylic Magnet Frames use 1 picture with a keepsake-style frame. They are great for gifting and memory displays.",
  },
  {
...
app.listen(port, () => {
  console.log(`Memory Magnets chatbot running on http://127.0.0.1:${port}`);
});
