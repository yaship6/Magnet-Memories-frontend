...
function Footer() {
  return (
    <footer className="relative bg-[#2f9f9a] text-[#f8f3e8] px-12 py-12">
      ...
      <div className="grid grid-cols-[1.2fr_0.7fr_1fr] gap-16">
        <div>
        ...
        <div className="flex flex-col justify-center">
          ...
          <div className="flex flex-col gap-4 text-xl font-medium">
            <Link to="/shop">Square Magnets</Link>
            <Link to="/shop">Strip Magnets</Link>
            <Link to="/shop">Polaroid Magnets</Link>
            <Link to="/customize">Custom Magnets</Link>
          </div>
        </div>

        <div className="flex flex-col items-start justify-center">
          <h3 className="text-sm mb-4">Get the freshest Memory Magnets news</h3>

          <div className="flex w-full max-w-md">
            <input
              type="email"
              placeholder="Your email here"
              className="flex-1 bg-transparent border border-[#8aa89a] px-4 py-3 outline-none"
            />
            <button className="border border-[#8aa89a] px-6 py-3 hover:bg-[#f8f3e8] hover:text-[#2f9f9a] transition">
              Subscribe
            </button>
          </div>

          <label className="flex gap-3 mt-5 text-xs text-[#c9d6cf]">
            <input type="checkbox" />
